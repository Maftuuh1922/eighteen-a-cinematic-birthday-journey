...
export function ArtistAbout() {
  return (
    <section className="snap-section bg-offWhite flex flex-col md:flex-row overflow-y-auto md:overflow-hidden hide-scrollbar">
      {/* Left Column: Image/Quote */}
      <div className="w-full md:w-[45%] min-h-[50dvh] md:h-full flex flex-col items-center justify-center p-[var(--pad-x)] pt-20 md:pt-[var(--pad-y)]">
        <motion.div
      ...
      {/* Right Column: Bio */}
      <div className="w-full md:w-[55%] min-h-[50dvh] md:h-full flex flex-col justify-center px-[var(--pad-x)] py-12 md:py-[var(--pad-y)] bg-white/50 md:bg-transparent">
        <motion.div
